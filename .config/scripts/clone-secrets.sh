...
for REPOSITORY in $(command ls -d $HOME/.config/vcsh/repo.d/*); do
...
vcsh clone git@github.com:sabrehagen/dotfiles-cloudflared 2>/dev/null &
vcsh clone git@github.com:sabrehagen/dotfiles-codex 2>/dev/null &
...
vcsh clone git@github.com:sabrehagen/dotfiles-gemini 2>/dev/null &
...
vcsh clone git@github.com:sabrehagen/dotfiles-gsd 2>/dev/null &
...
vcsh clone git@github.com:sabrehagen/dotfiles-ollama 2>/dev/null &
...
vcsh clone git@github.com:sabrehagen/dotfiles-pi 2>/dev/null &
vcsh clone git@github.com:sabrehagen/dotfiles-slack-tui 2>/dev/null &
vcsh clone git@github.com:sabrehagen/dotfiles-tailscale 2>/dev/null &
vcsh clone git@github.com:sabrehagen/dotfiles-x2x 2>/dev/null &
